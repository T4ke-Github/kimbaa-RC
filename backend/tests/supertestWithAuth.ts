 ...
 */
export async function performAuthentication(identifier: string, password: string) {
     const testee = supertest(app);
     const res = parseCookies(await testee.post(`/api/login`).send({ studentId: identifier, password }));
